...
;(function ($, window, document, undefined) {
  ...
  Calendar.prototype = {
    showHoverInfo: function (obj) { // hover 时显示当天信息
      ...
      var offset_t = $(obj).offset().top + (this.$calendar_today.height() - $(obj).height()) / 2-70;
      var offset_l = $(obj).offset().left + $(obj).width()-270;
    ...
    renderDOM: function () { // 渲染DOM
      ...
      this.$calendar_today = $('<div class="calendar-today" style="width:100px;height:68px"></div>');
